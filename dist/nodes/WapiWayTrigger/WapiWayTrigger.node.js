...
exports.WapiWayTrigger = void 0;
class WapiWayTrigger {
    constructor() {
        this.description = {
        ...
        this.webhookMethods = {
            default: {
                ...
                async create() {
                    ...
                    const response = await this.helpers.httpRequestWithAuthentication.call(this, 'wapiWayApi', {
                        method: 'POST',
                ...
                async delete() {
                    ...
                    try {
                        await this.helpers.httpRequestWithAuthentication.call(this, 'wapiWayApi', {
                            method: 'DELETE',
...
exports.WapiWayTrigger = WapiWayTrigger;
